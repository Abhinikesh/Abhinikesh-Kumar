    ...
    >
      ...
      <div className="absolute inset-0">
        <div
          ...
          rounded-full
          bg-gradient-to-r from-[#1E293B] via-[#F59E0B] to-[#FFFBEB]
        ...
        <div
          ...
          max-w-[500px] max-h-[500px] 
          rounded-full 
          bg-gradient-to-r from-[#1F2937] via-[#F59E0B] to-[#ECFEFF] 
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        ...
        >
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            ...
            {/* name */}
            <motion.h1
              className="text-4xl sm:text-5xl md:text-5xl lg:text-6xl font-bold text-transparent bg-clip-text 
              bg-gradient-to-r from-[#06B6D4] via-[#ECFEFF] to-[#06B6D4] drop-shadow-lg"
            ...
            >
              I build full-stack web apps and AI-powered systems that solve real problems —
              from MERN-based platforms to IoT integrations, with a growing focus on
