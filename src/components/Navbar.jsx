...
useEffect(() => {
  ...
  return(
    ...
    <div className="hidden lg:block">
      <a href="#Contact"
      className="bg-gradient-to-r from-amber-500 to-rose-500 text-white px-5 py-2 rounded-full font-medium shadow-lg hovwr-90 transition-opacity duration-300" >
